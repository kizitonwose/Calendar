...
import com.kizitonwose.calendar.data.MonthDataProducer
import com.kizitonwose.calendar.data.VisibleItemState
import kotlinx.datetime.DayOfWeek

@Composable
fun <YearMonth : Comparable<YearMonth>, CalendarMonth> __rememberCalendarStateImpl(
...
class CalendarState<YearMonth, CalendarMonth> internal constructor(
    ...
    private fun monthDataChanged() {
        store.clear()
//        checkDateRange(startMonth, endMonth) TODO KMP
    ...
    private fun getScrollIndex(month: YearMonth): Int? {
        if (!data.isInRange(startMonth, endMonth, month)) {
            // TODO KMP
