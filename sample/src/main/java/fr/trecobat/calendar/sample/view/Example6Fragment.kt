...
import fr.trecobat.calendar.sample.databinding.Example6CalendarDayBinding
import fr.trecobat.calendar.sample.databinding.Example6CalendarHeaderBinding
import fr.trecobat.calendar.sample.databinding.Example6FragmentBinding
import fr.trecobat.calendar.sample.shared.displayText
import fr.trecobat.calendar.view.MarginValues
 ...
 * ```
 * -keepclassmembers class fr.trecobat.calendar.sample.view.Example6MonthView {
 ...
 *  ```
 *  -keepnames class fr.trecobat.calendar.sample.view.Example6MonthView
 *  ```
 *  Please replace fr.trecobat.calendar.sample.view.Example6MonthView in the
